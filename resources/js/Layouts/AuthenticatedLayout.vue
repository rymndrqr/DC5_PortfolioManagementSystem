        ...
        <aside class="w-60 shrink-0 bg-zinc-900 border-r border-zinc-800 flex flex-col">
            ...
            <nav class="flex-1 py-5 px-3 space-y-0.5">
                ...
                <div class="pt-4 mt-4 border-t border-zinc-800">
                    <a href="/portfolio"
                        class="flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium text-zinc-400 hover:text-white hover:bg-zinc-800 transition-all">
                        <span class="text-sm text-amber-300">📁</span> View Portfolio
                    </a>
                </div>
            </nav>
